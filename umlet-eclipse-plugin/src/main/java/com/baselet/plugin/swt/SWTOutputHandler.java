...
public class SWTOutputHandler {
	public static void createAndOutputToFile(String extension, File file, Collection<GridElement> selection) throws Exception {
		OutputStream ostream = new FileOutputStream(file);
		createToStream(extension, ostream, selection);
		ostream.close();
	}

	public static void createToStream(String extension, OutputStream ostream, Collection<GridElement> elementsToDraw) throws Exception {
		// this is only used to get a font handler
		DiagramHandler diagramHandler = DiagramHandler.forExport(null);
		SWTOutputHandler.exportToOutputStream(extension, ostream, elementsToDraw, diagramHandler.getFontHandler());
	}
